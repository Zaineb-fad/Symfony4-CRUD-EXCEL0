...
class Excel_2Controller  extends Controller
{
    /**
     * @Route("/excel/2", name="excel2")
     */
...
$a=1;
  ...
  $cart_lines= $em->getRepository('App\Entity\CartLine')-> findAll();
   foreach ($cart_lines as $cart_line)
         ...
         $spreadsheet->setActiveSheetIndex(0)
                        ...
                        ->setCellValue('A' . (string)($a), $cart_line->getQuantity())
                         
                        ->setCellValue('B' . (string)($a), $cart_line->getVariant())
						 ->setCellValue('C' . (string)($a), $cart_line->getCart());
