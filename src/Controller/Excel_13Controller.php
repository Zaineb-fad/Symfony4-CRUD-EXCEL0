...
class Excel_13Controller  extends Controller
{
    /**
     * @Route("/excel/13", name="excel13")
     */
    public function index(): Response
    {
      $spreadsheet = new Spreadsheet();
        ...
        $sheet->setCellValue('B1', 'LicencePlate');
...
$a=1;
  ...
  $transportations= $em->getRepository('App\Entity\Transportation')-> findAll();
   foreach ($transportations as $transportation)
         ...
         $spreadsheet->setActiveSheetIndex(0)
                        ...
                        ->setCellValue('A' . (string)($a), $transportation->getColor())
                         
                        ->setCellValue('B' . (string)($a), $transportation->getLicencePlate());
}
