...
class Excel_10Controller  extends Controller
{
    /**
     * @Route("/excel/10", name="excel10")
     */
...
$a=1;
  ...
  $sections= $em->getRepository('App\Entity\Section')-> findAll();
   foreach ($sections as $section)
         ...
         $spreadsheet->setActiveSheetIndex(0)
                        ...
                        ->setCellValue('A' . (string)($a), $section->getName())
                         
                        ->setCellValue('B' . (string)($a), $section->getCity());
}
