...
class TransportationController extends AbstractController
{
    ...
    public function index(TransportationRepository $transportationRepository): Response
    {
        return $this->render('transportation/index.html.twig', [
            'transportations' => $transportationRepository->findAll(),
        ]);
    }
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('transportation_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    {
        return $this->render('transportation/show.html.twig', [
            'transportation' => $transportation,
        ]);
    }
    ...
    /**
     * @Route("/{id}", name="transportation_delete", methods={"POST"})
     */
